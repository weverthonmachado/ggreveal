...
plots_pw <- reveal_save(reveal_patchwork(pw), 
                          "pw.png", width=9, height=5, bg = "white", path = tempdir())
...
Then use one of the `reveal_*` functions (`reveal_groups()`, `reveal_layers()`, `reveal_aes()`, `reveal_panel()`, `reveal_axis()`) to obtain a list of plots that show elements incrementally. 
